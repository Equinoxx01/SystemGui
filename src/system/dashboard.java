...
public class dashboard extends javax.swing.JFrame {
    ...
    public dashboard() {
        ...
        JButton[] buttons = { dashboard, customer, products, orders, reports, manage, logout };
    ...
    private void initComponents() {
        ...
        manage.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        manage.setText("Manage Staff");
        ...
        jPanel2.add(manage, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 320, 150, 30));
    ...
    private void manageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_manageMouseClicked
        resetMenuColors();
        manage.setBackground(activeColor);
